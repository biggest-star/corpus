	...
	var Map = {
		...
		map: function(){
			$('.eut-map').each( function() {
				...
				var tileOptions = {
					subdomains: eut_maps_data.map_tile_url_subdomains,
					attribution: eut_maps_data.map_tile_attribution
				};
				L.tileLayer( eut_maps_data.map_tile_url, tileOptions ).addTo(lmap);
