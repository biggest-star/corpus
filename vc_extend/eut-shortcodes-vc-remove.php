...
if ( function_exists( 'vc_remove_element' ) ) {
	...
	add_action( 'init', 'eut_remove_vc_shortcodes' );

	if ( !function_exists( 'eut_remove_vc_shortcodes' ) && function_exists( 'vc_remove_element' ) ) {

		function eut_remove_vc_shortcodes() {

			if ( !eut_vc_social_elements_visibility() ) {
				//Social
			...
			if ( !eut_vc_wp_elements_visibility() ) {
				//WordPress
			...
			if ( !eut_vc_charts_visibility() ) {
				//Charts
				vc_remove_element('vc_round_chart');
				vc_remove_element('vc_line_chart');
			}

			if ( !eut_vc_other_elements_visibility() ) {
				//Other
...
if ( is_admin() ) {
	if ( ! function_exists('eut_remove_vc_boxes') ) {
		function eut_remove_vc_boxes(){
	...
	add_action('do_meta_boxes', 'eut_remove_vc_boxes');
}
