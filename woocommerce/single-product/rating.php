...
if ( $rating_count > 0 ) : ?>
	...
	<div class="woocommerce-product-rating">
		...
		<?php if ( comments_open() ) : ?><a href="#reviews" class="eut-small-text eut-review-link woocommerce-review-link" rel="nofollow">(<?php printf( _n( '%s customer review', '%s customer reviews', $review_count, 'woocommerce' ), '<span class="count">' . $review_count . '</span>' ); ?>)</a><?php endif ?>
	</div>
